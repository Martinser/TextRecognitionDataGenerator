...
def load_fonts(lang: str) -> List[str]:
    ...
    if lang in os.listdir(os.path.join(os.path.dirname(__file__), "fonts")):
        #print(os.path.join(os.path.dirname(__file__), "fonts/{}".format(lang)))
        return [
...
def mask_to_bboxes(mask: List[Tuple[int, int, int, int]], tess: bool = False):
    ...
    while True:
        try:
            ...
            #print("cnmcnmcnmcncmcnmcnmcncmcnmcnmcncmcnmcnm")
            #print(bboxes)
            i += 1
...
def draw_bounding_boxes(
    ...
    #img.save('C:/Users/86188/Desktop/111/3.jpg')
'''
draw_bounding_boxes('C:/Users/86188/Desktop/111/3_2971.jpg',[(7, 71 ,119 ,186),
(9, 209 ,117 ,316),
(9, 302 ,118 ,421)])
...
def pre_drawbbox(path1,path2):
    with open(path2,'r')as f1:
        ...
        for i in range(len(content)):
            ...
            #print(temp[0])
            vs=(int(temp[0]),int(temp[1]),int(temp[2]),int(temp[3]))
            #print(vs)
            list_temp.append(vs)
        draw_bounding_boxes(path1,list_temp)


#pre_drawbbox('C:/Users/86188/Desktop/111/1.jpg','C:/Users/86188/Desktop/111/1.txt')
